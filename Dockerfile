...
COPY . /usr/java
WORKDIR /usr/java
RUN mvn clean install sonar:sonar -DskipTests -Dsonar.projectKey=ctsproject -Dsonar.host.url=http://localhost:32769 -Dsonar.login=6e89d16134dbd64e2441812cabb25769e110676d
