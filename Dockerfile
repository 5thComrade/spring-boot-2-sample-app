...
COPY . /usr/java
WORKDIR /usr/java
RUN mvn clean install -DskipTests -Dsonar.projectKey=ctsproject -Dsonar.host.url=http://epic_keller:32769 -Dsonar.login=7b7e9625ae54f2b322314dc8dc013f993fddd0c9
